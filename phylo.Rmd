...
**Cladogram** Branch lengths are meaningless (usually same length)

**Chronogram** Branch lengths are proportional to time. The distance from root to leaf is the same for every leaf.

**Phylogram** Branch lengths are proportional to evolutionary divergence. The distance from root to leaf is not the same for every leaf.
